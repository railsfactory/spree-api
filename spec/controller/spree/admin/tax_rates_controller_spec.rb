...
describe Spree::Admin::TaxRatesController , :type => "controller" do
  ...
  describe "GET show" do
    it "user To display particular Tax rates" do
  ...
  describe "POST create" do
    it "user To create a TaxRate" do
      post :create, :tax_rate => { :zone_id => "" , :tax_category_id =>"" , :amount => 250 , :included_in_price => true , :calculator_type => "Spree::Calculator::DefaultTax"}  ,:format=>:json
      response.code.should == "200"
    end
  end	
  ...
  describe "POST update" do
    it "user To update a TaxRate" do
      put :update, :id => 3 , :tax_rate => { :zone_id => @zone.id , :tax_category_id => @tax_category.id , :amount => 1045 , :included_in_price => true , :calculator_type => "Spree::Calculator::DefaultTax"}  ,:format=>:json
      response.code.should == "200"
    end
  end	
  
  describe "DELETE destroy" do
    it "user To delete a Tax rate" do
