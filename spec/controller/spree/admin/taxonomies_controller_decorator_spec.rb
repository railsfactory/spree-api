...
describe Spree::Admin::TaxonomiesController , :type => "controller" do
  ...
  describe "POST create" do
    it "user To create a Taxonomy" do
      post :create, :taxonomy => { }, :authentication_token => "C_-CfKztV6n0y3O8NTRD" , :format=> :json 
  ...
  describe "POST update" do
    it "user To update a particular Taxonomy" do
      post :update, :id =>6 , :taxonomy => { :name => "Sedin" }, :authentication_token => "C_-CfKztV6n0y3O8NTRD" , :format=> :json 
      response.code.should == "200"
    end
  end
  ...
  describe "DELETE destroy" do
    it "user To delete a particular Taxonomy" do
      delete :destroy, :id => 9, :taxonomy => { :name => "Sedin" }, :authentication_token => "C_-CfKztV6n0y3O8NTRD" , :format=> :json 
      response.code.should == "200"
    end
  end
end
