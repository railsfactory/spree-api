...
describe   Spree::Admin::ShippingMethodsController,:type=>"controller" do
  ...
  describe " ZonesController" do
    def valid_attributes
      {
        :name=>"sedin 2 way", :zone_id=>@pro.to_param, :display_on=>"", :calculator_type=>"Spree::Calculator::FlatPercentItemTotal",:shipping_category_id=>"727197546"
      }
    end
    ...
    before(:each) do
      ...
      @pro=Spree::Zone.create(:name=>"railscfactory",:description=>"software concern")
    ...
    describe "To get the index of the ShippingMethod controller" do
      ...
      it "should get the ShippingMethod" do
        store = Spree::ShippingMethod.create! valid_attributes
        get :show, {:id => 9, :format => :json}
        response.code.should == "200"
      end
      it "should be successful create ShippingMethod" do
        post :create , :shipping_method => {:name=>"sedin 2 way", :zone_id=>@pro.to_param, :display_on=>"", :calculator_type=>"Spree::Calculator::FlexiRate"}, :format => :json
        response.code.should == "201"
      end
      it "should be successful create ShippingMethod" do
        post :create , :shipping_method => {:name=>"sedin 2 way", :zone_id=>"", :display_on=>"", :calculator_type=>"Spree::Calculator::FlexiRate"}, :format => :json
        response.code.should == "200"
      end
      it "should be successful update ShippingMethod" do
        store = Spree::ShippingMethod.create! valid_attributes
      ...
      it "should be successful update ShippingMethod" do
        store = Spree::ShippingMethod.create! valid_attributes
        put :update , :id=>9,:shipping_method => {:name=>""}, :format => :json
        response.code.should == "200"
      end
